 ...
 * Add any custom palettes here and add them to GradientPalettes::initialize()
 */
 ...
 * Class code follows.
 */
bool GradientPalettes::m_initialized = false;
std::map<String, CRGBPalette16> GradientPalettes::m_palettes;

void GradientPalettes::initialize()
{
    if (m_initialized == false)
    {
        m_palettes["bhw2_thanks_gp"]      = bhw2_thanks_gp;
        m_palettes["bhw2_redrosey_gp"]    = bhw2_redrosey_gp;
        m_palettes["bluered_gp"]          = bluered_gp;
        m_palettes["bhw2_xmas_gp"]        = bhw2_xmas_gp;
        m_palettes["bhw2_xc_gp"]          = bhw2_xc_gp;
        m_palettes["bhw1_04_gp"]          = bhw1_04_gp;
        m_palettes["bhw4_051_gp"]         = bhw4_051_gp;
        m_palettes["fs2006_gp"]           = fs2006_gp;
        m_palettes["blue_g2_5_gp"]        = blue_g2_5_gp;
        m_palettes["bhw3_41_gp"]          = bhw3_41_gp;
        m_palettes["test_gp"]             = test_gp;
        m_palettes["bhw2_greenman_gp"]    = bhw2_greenman_gp;
        m_palettes["Pills_3_gp"]          = Pills_3_gp;
        m_palettes["Orange_to_Purple_gp"] = Orange_to_Purple_gp;

        m_initialized = true;
    }
}

CRGBPalette16& GradientPalettes::get(String paletteName)
{
    if (m_initialized == false)
